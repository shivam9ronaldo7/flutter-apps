...
class QuizBrain{
  ...
  bool checkIfNextQuestionAvailable(){
    if(position < _questionList.length-1){
      ++position;
      return true;
    } else{
      return false;
  ...
  String getQuestion(){
    return _questionList[position].questionText;
  }

  bool getAnswer(){
    return _questionList[position].questionAnswer;
  }
